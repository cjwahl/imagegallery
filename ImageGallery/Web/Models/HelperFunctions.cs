...
namespace ImageGallery.Models
{
    public static class HelperFunctions
    {
        ...
        public static List<Album> GetAlbumList()
        {
            ...
            try
            {
                ...
                foreach (DataRow row in dt.Rows)
                {
                    ...
                    album.Year = !string.IsNullOrEmpty(row["year"].ToString()) ? Convert.ToInt32(row["year"].ToString()) : Convert.ToInt32("2017");
                    albums.Add(album);
                }
            }
            catch (Exception ex)
        ...
        public static void UploadImage(HttpPostedFileBase file, string imageSize, string directoryName, string name)
        {
            if (file != null && file.ContentLength > 0 && file.ContentType.Contains("image"))
            {
                ...
                {
                    if (imageSize == "full" || directoryName == "Dashboard")
                    {
                ...
                {
                    if (imageSize == "thumb" || directoryName == "Dashboard")
                    {
